...
export default function App() {
  ...
  const L6 = () => <SvgWrap><defs><clipPath id="keyhole-clip"><path d="M50 15 A22 22 0 0 0 32.5 48.5 L25 85 L75 85 L67.5 48.5 A22 22 0 0 0 50 15 Z" /></clipPath></defs><g clipPath="url(#keyhole-clip)"><TerrazzoPattern /></g><path d="M50 15 A22 22 0 0 0 32.5 48.5 L25 85 L75 85 L67.5 48.5 A22 22 0 0 0 50 15 Z" fill="none" stroke={colors.brass} strokeWidth="1.5" strokeLinejoin="round" /><circle cx="50" cy="38" r="5" fill={currentBg} stroke={colors.terracotta} strokeWidth="1.5" /><path d="M48.5 42 L48.5 55 L51.5 55 L51.5 42 Z" fill={colors.terracotta} /></SvgWrap>;
  ...
  const concepts: Array<{ id: number; title: string; desc: string; component: React.ReactNode; layout: 'horizontal' | 'vertical' | 'none' | 'integrated'; fontTheme: keyof typeof fontThemes }> = [
    ...
    { id: 6, title: 'The Terrazzo Keyhole', desc: 'An elegant, vintage keyhole silhouette acting as a lens into the vibrant, stained-glass mosaic texture.', component: <L6 />, layout: 'vertical', fontTheme: 'heritage' },
