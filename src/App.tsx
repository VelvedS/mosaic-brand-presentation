...
export default function App() {
  ...
  // REDESIGNED: 4. The Gilded Diamond
  const L4 = () => <SvgWrap><polygon points="50,5 95,50 50,95 5,50" fill="none" stroke={colors.brass} strokeWidth="1.5"/><polygon points="50,15 85,50 50,85 15,50" fill="none" stroke={currentText} strokeWidth="0.5" opacity="0.6"/><path d="M35 60 L35 40 L50 50 L65 40 L65 60" fill="none" stroke={colors.terracotta} strokeWidth="2" strokeLinejoin="miter"/><circle cx="50" cy="25" r="2" fill={colors.brass}/><circle cx="50" cy="75" r="2" fill={colors.brass}/></SvgWrap>;
  
  const L5 = () => <SvgWrap><defs><clipPath id="prism-clip"><polygon points="50,10 85,50 50,90 15,50" /></clipPath></defs><g clipPath="url(#prism-clip)"><TerrazzoPattern /></g><polygon points="50,10 85,50 50,90 15,50" fill="none" stroke={colors.brass} strokeWidth="1.5" /><polygon points="50,20 75,50 50,80 25,50" fill="none" stroke={currentText} strokeWidth="0.5" opacity="0.6" /><circle cx="50" cy="50" r="4" fill={colors.terracotta} /></SvgWrap>;
  
  // REDESIGNED: 6. The Stained Glass Plate
  const L6 = () => <SvgWrap><circle cx="50" cy="50" r="46" fill="none" stroke={colors.brass} strokeWidth="1.5" /><defs><clipPath id="plate-terrazzo"><circle cx="50" cy="50" r="38" /></clipPath></defs><g clipPath="url(#plate-terrazzo)"><TerrazzoPattern /></g><circle cx="50" cy="50" r="38" fill="none" stroke={currentBg} strokeWidth="3" /><circle cx="50" cy="50" r="38" fill="none" stroke={currentText} strokeWidth="1" /><ellipse cx="50" cy="50" rx="15" ry="38" fill="none" stroke={currentBg} strokeWidth="3" /><ellipse cx="50" cy="50" rx="15" ry="38" fill="none" stroke={colors.brass} strokeWidth="1" /><line x1="12" y1="50" x2="88" y2="50" stroke={currentBg} strokeWidth="3" /><line x1="12" y1="50" x2="88" y2="50" stroke={colors.brass} strokeWidth="1" /><circle cx="50" cy="50" r="5" fill={colors.terracotta} stroke={currentBg} strokeWidth="1.5" /></SvgWrap>;
  ...
  const concepts: Array<{ id: number; title: string; desc: string; component: React.ReactNode; layout: 'horizontal' | 'vertical' | 'none' | 'integrated'; fontTheme: keyof typeof fontThemes }> = [
    ...
    { id: 4, title: 'The Gilded Diamond', desc: 'A pristine, high-fashion double rhombus framing an elegant M. Pure structural luxury.', component: <L4 />, layout: 'vertical', fontTheme: 'gallery' },
    { id: 5, title: 'The Stained Glass Prism', desc: 'A soaring, highly structured diamond frame housing the signature organic broken-stone mosaic.', component: <L5 />, layout: 'vertical', fontTheme: 'avantgarde' },
    { id: 6, title: 'The Stained Glass Plate', desc: 'An exquisite top-down plate silhouette doubling as a global meridian. The vibrant mosaic acts as the culinary centerpiece.', component: <L6 />, layout: 'vertical', fontTheme: 'heritage' },
